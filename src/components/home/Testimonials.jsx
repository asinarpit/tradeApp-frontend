    ...
    <section className="bg-gray-100 py-12 md:py-16">
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-center mb-8 sm:mb-12">
          <div className="flex flex-col items-start">
            <div className="flex items-center">
                ...
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-800">Testimonials</h2>
            </div>
        ...
        <div className="relative">
          ...
          >
            {testimonials.map((testimonial) => (
              <SwiperSlide key={testimonial.id}>
                {/* Testimonial Card */}
                <div className="bg-white p-8 pt-0 rounded-xl shadow-lg border border-gray-100 flex flex-col items-center text-center relative mt-16 mx-4">
                  
                  
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2">

                    <div className="w-28 h-28 rounded-full border-4 border-white shadow-md overflow-hidden ring-4 ring-yellow-500/50">
                  ...
                  <div className="mt-16 pt-4">
                    <p className="text-xl italic text-gray-800 relative mb-4">
          ...
          <div className="swiper-button-prev-custom-testi hidden lg:block absolute -left-14 top-1/2 -translate-y-1/2 z-10 cursor-pointer bg-gray-400 hover:bg-gray-300 p-2 rounded-full transition-all">
           <ChevronLeft className="text-white" />
          </div>

          <div className="swiper-button-next-custom-testi hidden lg:block absolute -right-14 top-1/2 -translate-y-1/2 z-10 cursor-pointer bg-gray-400 hover:bg-gray-300 p-2 rounded-full transition-all">
            {/* Right Arrow Icon */}
