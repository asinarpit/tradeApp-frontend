    ...
    <section className="bg-white py-16">
      <div className="max-w-screen-xl mx-auto px-4 flex flex-col lg:flex-row items-center lg:items-start gap-12">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-start">
          ...
          <button className="bg-black text-white py-3 px-8 text-lg font-semibold rounded-full hover:bg-gray-800 transition-colors">
            Login
          </button>
        </div>
        ...
        <div className="w-full lg:w-1/2 flex justify-center relative">
          ...
          <div className="w-[600px] h-[550px] flex items-center justify-center text-gray-500 overflow-hidden">
